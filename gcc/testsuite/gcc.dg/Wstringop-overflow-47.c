...
{
  extern char warn_a32[32];   // { dg-message "at offset (32|25|1|17) into destination object 'warn_a32' of size 32" "pr97027" }

  void *p = warn_a32 + 1;
  *(C32*)p = (C32){ c };      // { dg-warning "writing (1 byte|8 bytes|16 bytes|32 bytes) into a region of size (0|7|15|31)" "pr97027" }
